  ...
  return (
    <div>
      <div className="py-5 flex justify-between items-center">
        ...
        {/* Add Product Button  */}
        <Link to={"/addproduct"}>
          <button className="px-5 py-2 bg-gray-50 border border-gray-100 rounded-lg">
            Add Product
          </button>
        </Link>
      </div>
              ...
              return (
                <tr key={index} className="text-gray-800">
                  ...
                  <td
                    ...
                    className="h-12 px-6 text-md transition duration-300 border-t border-l first:border-l-0 border-gray-100 stroke-slate-500 text-slate-500 text-green-500 cursor-pointer "
                  >
                    Edit
                  </td>
